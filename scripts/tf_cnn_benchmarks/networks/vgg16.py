...
class Vgg11Model(model.CNNModel):
  ...
  def __init__(self, params=None):
    super(Vgg11Model, self).__init__('vgg11', model.MODEL_TYPE_IMAGE_CLASSIFICATION, 224, 64, 0.005, params=params)
...
class UserModel(model.CNNModel):
  ...
  def __init__(self, params=None):
    super(UserModel, self).__init__('VGG16', model.MODEL_TYPE_IMAGE_CLASSIFICATION, 224, 64, 0.005, params=params)
