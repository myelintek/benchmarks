...
class UserModel(model_lib.CNNModel):
  ...
  def __init__(self, model='Resnet50', layer_counts=(3, 4, 6, 3), params=None):
    default_batch_sizes = {
        'resnet50': 64,
        'resnet101': 32,
        'resnet152': 32,
    ...
    super(UserModel, self).__init__(model, model_lib.MODEL_TYPE_IMAGE_CLASSIFICATION,224, batch_size, .128,
