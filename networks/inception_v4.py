...
class Inceptionv3Model(model.CNNModel):
  ...
  def __init__(self, auxiliary=False, params=None):
    ...
    super(Inceptionv3Model, self).__init__(
        'inception3', model.MODEL_TYPE_IMAGE_CLASSIFICATION, 299, 32, 0.005, params=params)
...
class UserModel(model.CNNModel):
  ...
  def __init__(self, params=None):
    super(UserModel, self).__init__(
        'Inception_v4', model.MODEL_TYPE_IMAGE_CLASSIFICATION,  299, 32, 0.005, params=params)
